...
[Poetry](https://python-poetry.org/) makes Python packaging and dependency
management easy and can be used with Chainguard Libraries for Python.
...
[[tool.poetry.source]]
name = "python-all"
url = "https://chainguard.jfrog.io/artifactory/api/pypi/python-all/simple"
priority = "primary"
```
